require 'mongoid/associations/embedded/embeds_one/binding'
require 'mongoid/associations/embedded/embeds_one/builder'
require 'mongoid/associations/embedded/embeds_one/proxy'
  ...
  module Associations
    module Embedded
      ...
      class EmbedsMany
        ...
        #
        # @return [ Associations::Embedded::EmbedsMany::Builder ] The builder object.
        #
        # @since 7.0

require 'mongoid/associations/referenced/has_and_belongs_to_many/binding'
require 'mongoid/associations/referenced/has_and_belongs_to_many/builder'
require 'mongoid/associations/referenced/has_and_belongs_to_many/proxy'
require 'mongoid/associations/referenced/has_and_belongs_to_many/eager'
  ...
  module Associations
    module Referenced
      ...
      class HasAndBelongsToMany
        ...
        #
        # @return [ Associations::HasAndBelongsToMany::Proxy ] The proxy class.
        #
        # @since 7.0
        def relation
          Proxy

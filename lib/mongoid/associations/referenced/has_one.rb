require 'mongoid/associations/referenced/has_one/binding'
require 'mongoid/associations/referenced/has_one/builder'
require 'mongoid/associations/referenced/has_one/proxy'
require 'mongoid/associations/referenced/has_one/eager'
  ...
  module Associations
    module Referenced
      ...
      class HasOne
        ...
        #
        # @return [ Associations::HasOne::Builder ] The builder object.
        #
        # @since 7.0
        ...
        #
        # @return [ Associations::HasOne::Proxy ] The proxy class.
        #
        # @since 7.0
        def relation
          HasOne::Proxy

require 'mongoid/associations/referenced/has_many/binding'
require 'mongoid/associations/referenced/has_many/builder'
require 'mongoid/associations/referenced/has_many/proxy'
require 'mongoid/associations/referenced/has_many/enumerable'
require 'mongoid/associations/referenced/has_many/eager'
  ...
  module Associations
    module Referenced
      ...
      class HasMany
        ...
        #
        # @return [ Associations::HasMany::Builder ] The builder object.
        #
        # @since 7.0
        ...
        #
        # @return [ Associations::HasMany::Proxy ] The proxy class.
        #
        # @since 7.0
        def relation
          Proxy
        ...
        #
        # @return [ Associations::Nested::Many ] The Nested Builder object.
        #
        # @since 7.0

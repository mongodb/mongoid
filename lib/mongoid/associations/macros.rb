    ...
    module Macros
      ...
      module ClassMethods
        ...
        def embedded_in(name, options = {}, &block)
          Mongoid::Associations::Embedded::EmbeddedIn.new(self, name, options, &block).tap do |assoc|
        ...
        def embeds_many(name, options = {}, &block)
          Mongoid::Associations::Embedded::EmbedsMany.new(self, name, options, &block).tap do |assoc|
            assoc.setup_instance_methods!
        ...
        def embeds_one(name, options = {}, &block)
          Mongoid::Associations::Embedded::EmbedsOne.new(self, name, options, &block).tap do |assoc|
            assoc.setup_instance_methods!
            self.embedded_relations = embedded_relations.merge(name.to_s => assoc)
            self.relations = relations.merge(name.to_s => assoc)
            aliased_fields[name.to_s] = assoc.store_as if assoc.store_as
        ...
        def has_many(name, options = {}, &block)
          Mongoid::Associations::Referenced::HasMany.new(self, name, options, &block).tap do |assoc|
            assoc.setup_instance_methods!
            self.relations = relations.merge(name.to_s => assoc)
          end
        end
        ...
        def has_and_belongs_to_many(name, options = {}, &block)
          Mongoid::Associations::Referenced::HasAndBelongsToMany.new(self, name, options, &block).tap do |assoc|
            assoc.setup_instance_methods!
            self.relations = relations.merge(name.to_s => assoc)
          end
        end
        ...
        def has_one(name, options = {}, &block)
          Mongoid::Associations::Referenced::HasOne.new(self, name, options, &block).tap do |assoc|
            self.relations = relations.merge(name.to_s => assoc)
            assoc.setup_instance_methods!
          end
        end

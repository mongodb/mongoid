  ...
  module Association
    module Referenced
      class HasMany
        ...
        # Transparent proxy for has_many associations, a one-to-many
        # relationship where the foreign key is stored in the opposite-side
        # document. An instance of this class is returned when calling the
        ...
        # methods to the _target of the association, i.e. the documents on
        # the opposite-side collection which must be loaded.

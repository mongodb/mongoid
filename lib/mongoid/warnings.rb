...
module Mongoid
  ...
  module Warnings
    ...
    warning :ignore_immutable_deprecated, 'Ignoring updates to immutable attribute `_id`. Please set Mongoid::Config.ignore_changes_to_immutable_attributes to false and update your code so that `_id` is never updated.'
  end
end

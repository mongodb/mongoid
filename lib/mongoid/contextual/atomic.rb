...
module Mongoid
  module Contextual
    module Atomic
      ...
      # @since 3.0.0
      def add_to_set(adds)
        query.update_many("$addToSet" => collect_operations(adds))
      end
      ...
      # @since 3.0.0
      def bit(bits)
        query.update_many("$bit" => collect_operations(bits))
      end
      ...
      # @since 3.0.0
      def pop(pops)
        query.update_many("$pop" => collect_operations(pops))
      end
      ...
      # @since 3.0.0
      def pull(pulls)
        query.update_many("$pull" => collect_operations(pulls))
      end
      ...
      # @since 3.0.0
      def pull_all(pulls)
        query.update_many("$pullAll" => collect_operations(pulls))
      end
      ...
      # @since 3.0.0
      def push(pushes)
        query.update_many("$push" => collect_operations(pushes))
      end
      ...
      # @since 3.0.0
      def push_all(pushes)
        query.update_many("$pushAll" => collect_operations(pushes))
      end
      ...
      def rename(renames)
        ...
        query.update_many("$rename" => collect_operations(operations))
      end
      ...
      # @since 3.0.0
      def set(sets)
        query.update_many("$set" => collect_operations(sets))
      end
      ...
      def unset(*args)
        ...
        query.update_many("$unset" => Hash[fields])
      end

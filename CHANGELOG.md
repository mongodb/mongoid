...
* #1149 Fixed metadata setting on belongs to relations.
...
* #1072 Writing attributes for nested documents can take a hash or array of
  hashes.
...
* #1075 self in default lambdas and procs now references the document
  instance.
...
* #656 Fixed reload breaking relations on unsetting of already loaded
  associations.

...
describe Mongoid::Equality do
  ...
  describe ".===" do
    ...
    context "when comparable is an instance of this document" do
      ...
      it "returns true" do
        expect(klass === person).to be_truthy
      end
    end
    ...
    context "when comparable is a relation of this document" do
      ...
      it "returns true" do
        expect(klass === relation).to be_truthy
      end
    end
    ...
    context "when the comparable is a subclass" do
      ...
      it "returns false" do
        expect(Person === Doctor).to be_falsey
      end
    end
    ...
    context "when the comparable is an instance of a subclass" do
      ...
      it "returns true" do
        expect(Person === Doctor.new).to be_truthy
      end
    end
  end
  ...
  describe "#===" do
    ...
    context "when comparable is the same type" do
      ...
      context "when the instance is different" do
        ...
        it "returns false" do
          expect(person === Person.new).to be_falsey
        end
      end
    ...
    context "when the comparable is a subclass" do
      ...
      it "returns false" do
        expect(person === Doctor.new).to be_falsey
      end
    end
    ...
    context "when comparing to a class" do
      ...
      context "when the class is a superclass" do
        ...
        it "returns true" do
          expect(Doctor.new === Person).to be_truthy
        end
      end
    end
  end

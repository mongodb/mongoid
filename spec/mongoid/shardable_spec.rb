        ...
        it 'raises a DocumentNotFound error with the shard key in the description on reload' do
          expect do
            instance.reload
                             ...
                             /Document not found for class Band with id #{instance.id} and shard key name: a-brand-name./)
        end
      end
    end
          ...
          it 'raises a DocumentNotFound error with the shard key in the description on reload' do
            expect do
              instance.reload
                               ...
                               /Document not found for class SmReview with id #{instance.id} and shard key author.name: Arthur Conan Doyle./)
          end
        end
      end
    end

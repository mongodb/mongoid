...
describe Mongoid::Interceptable do
  ...
  describe ".before_create" do
    ...
    context "callback returns true" do
      ...
      it "gets saved" do
        expect(artist.persisted?).to be_truthy
      end
    end
    ...
    context "callback returns false" do
      ...
      it "does not get saved" do
        expect(artist.persisted?).to be_falsey
      end
    end
  end
    ...
    context "when creating" do
      ...
      context "when the callback returns true" do
        ...
        it "the save returns true" do
          expect(artist.save).to be_truthy
        end
      end
      ...
      context "when callback returns false" do
        ...
        it "the save returns false" do
          expect(artist.save).to be_falsey
        end
      end
    end
  ...
  describe ".before_destroy" do
    ...
    context "when the callback returns false" do
      ...
      it "the destroy returns false" do
        expect(artist.destroy).to be_falsey
      end
    end
    ...
    context "when cascading callbacks" do
      ...
      it "executes the child destroy callbacks" do
        expect(record.before_destroy_called).to be_truthy
      end
    end
  end
  ...
  describe "#run_after_callbacks" do
    ...
    it "runs the after callbacks" do
      expect(object.after_save_called).to be_truthy
    end

    it "does not run the before callbacks" do
      expect(object.before_save_called).to be_falsey
    end
  end
  ...
  describe "#run_before_callbacks" do
    ...
    it "runs the before callbacks" do
      expect(object.before_save_called).to be_truthy
    end

    it "does not run the after callbacks" do
      expect(object.after_save_called).to be_falsey
    end
  end
      ...
      context "when the child does not have the same callback defined" do
        ...
        context "when running the callbacks directly" do
          ...
          it "does not cascade to the child" do
            expect(band.run_callbacks(:rearrange)).to be_truthy
          end
        end
        ...
        context "when the callbacks get triggered by a destroy" do
          ...
          it "does not cascade to the child" do
            ...
            expect(band.update_attributes(attributes)).to be_truthy
          end
        end
      end
    end
      ...
      describe "#after_create" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(label.after_create_called).to be_truthy
            end
          end
        ...
        context "when the child is persisted" do
          ...
          it "does not execute the callback" do
            expect(label.after_create_called).to be_falsey
          end
        end
      end
      ...
      describe "#after_save" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(label.after_save_called).to be_truthy
            end
          end
      ...
      describe "#after_update" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "does not execute the callback" do
              expect(label.after_update_called).to be_falsey
            end
          end
        ...
        context "when the child is persisted" do
          ...
          context "when the child is dirty" do
            ...
            it "executes the callback" do
              expect(label.after_update_called).to be_truthy
            end
          end
      ...
      describe "#after_validation" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(label.after_validation_called).to be_truthy
            end
          end
      ...
      describe "#before_create" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(record.before_create_called).to be_truthy
            end
          end
        ...
        context "when the child is persisted" do
          ...
          it "does not execute the callback" do
            expect(record.before_create_called).to be_falsey
          end
        end
      end
      ...
      describe "#before_save" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(record.before_save_called).to be_truthy
            end

            it "persists the change" do
              expect(band.reload.records.first.before_save_called).to be_truthy
            end
          end
      ...
      describe "#before_update" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "does not execute the callback" do
              expect(record.before_update_called).to be_falsey
            end
          end
        ...
        context "when the child is persisted" do
          ...
          context "when the child is dirty" do
            ...
            it "executes the callback" do
              expect(record.before_update_called).to be_truthy
            end

            it "persists the change" do
              expect(band.reload.records.first.before_update_called).to be_truthy
            end
          end
      ...
      describe "#before_validation" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(record.before_validation_called).to be_truthy
            end

            it "persists the change" do
              expect(band.reload.records.first.before_validation_called).to be_truthy
            end
          end
      ...
      describe "#before_create" do
        ...
        context "when the child is new" do
          ...
          context "when the root is new" do
            ...
            it "executes the callback" do
              expect(track.before_create_called).to be_truthy
            end
          end
        ...
        context "when the child is persisted" do
          ...
          it "does not execute the callback" do
            expect(track.before_create_called).to be_falsey
          end
        end
      end
      ...
      describe "#before_save" do
        ...
        context "when the child is new" do
          ...
          context "when the root is new" do
            ...
            it "executes the callback" do
              expect(track.before_save_called).to be_truthy
            end

            it "persists the change" do
              expect(reloaded.tracks.first.before_save_called).to be_truthy
            end
          end
      ...
      describe "#before_update" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "does not execute the callback" do
              expect(track.before_update_called).to be_falsey
            end
          end
        ...
        context "when the child is persisted" do
          ...
          context "when the child is dirty" do
            ...
            it "executes the callback" do
              expect(track.before_update_called).to be_truthy
            end

            it "persists the change" do
              expect(reloaded.tracks.first.before_update_called).to be_truthy
            end
          end
      ...
      describe "#before_validation" do
        ...
        context "when the child is new" do
          ...
          context "when the parent is new" do
            ...
            it "executes the callback" do
              expect(track.before_validation_called).to be_truthy
            end
          end

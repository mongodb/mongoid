...
describe Mongoid::Matchable::Lt do
  ...
  describe "#matches?" do
    ...
    context "when the value is larger" do
      ...
      it "returns false" do
        expect(matcher.matches?("$lt" => 3)).to be_falsey
      end
    end
    ...
    context "when the value is smaller" do
      ...
      it "returns true" do
        expect(matcher.matches?("$lt" => 10)).to be_truthy
      end
    end
    ...
    context "when the value is nil" do
      ...
      it "returns false" do
        expect(matcher.matches?("$lt" => 5)).to be_falsey
      end
    end
    ...
    context "when the value is an array" do
      context "there are value valid" do
        ...
        it "returns true" do
          expect(matcher.matches?("$lt" => 5)).to be_truthy
        end
      end

...
describe Mongoid::Matchable::Lte do
  ...
  describe "#matches?" do
    ...
    context "when the value is larger" do
      ...
      it "returns false" do
        expect(matcher.matches?("$lte" => 3)).to be_falsey
      end
    end
    ...
    context "when the value is smaller" do
      ...
      it "returns true" do
        expect(matcher.matches?("$lte" => 10)).to be_truthy
      end
    end
    ...
    context "when the value is equal" do
      ...
      it "returns true" do
        expect(matcher.matches?("$lte" => 5)).to be_truthy
      end
    end
    ...
    context "when the value is nil" do
      ...
      it "returns false" do
        expect(matcher.matches?("$lte" => 5)).to be_falsey
      end
    end

  ...
  describe "#matches?" do
    ...
    context "when comparing strings" do
      ...
      context "when the values are equal" do
        ...
        it "returns true" do
          expect(matcher.matches?("Testing")).to be_truthy
        end
      end
      ...
      context "when the values are not equal" do
        ...
        it "returns false" do
          expect(matcher.matches?("Other")).to be_falsey
        end
      end
    end
    ...
    context "when comparing object ids" do
      ...
      context "when the values are equal" do
        ...
        it "returns true" do
          expect(matcher.matches?(object_id)).to be_truthy
        end
      end
      ...
      context "when the values are not equal" do
        ...
        it "returns false" do
          expect(matcher.matches?(BSON::ObjectId.new)).to be_falsey
        end
      end
    end
    ...
    context "when comparing a string to an array" do
      ...
      context "when the attribute contains the value" do
        ...
        context "when the value is a string" do
          ...
          it "returns true" do
            expect(matcher.matches?("Test1")).to be_truthy
          end
        end
        ...
        context "when the value is a regexp" do
          ...
          it "returns true" do
            expect(matcher.matches?(/^Test[3-5]$/)).to be_truthy
          end
        end
      end
      ...
      context "when the attribute does not contain the value" do
        ...
        it "returns false" do
          expect(matcher.matches?("Test4")).to be_falsey
        end
      end
    end
    ...
    context "when comparing an array to an array" do
      ...
      context "when the attribute contains the value" do
        ...
        it "returns true" do
          expect(matcher.matches?(["Test1", "Test2", "Test3"])).to be_truthy
        end
      end
      ...
      context "when the attribute does not contain the value" do
        ...
        it "returns false" do
          expect(matcher.matches?(["Test1", "Test2"])).to be_falsey
        end
      end
    end
  end

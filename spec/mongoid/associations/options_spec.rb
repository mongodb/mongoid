...
describe Mongoid::Associations::Options do
  ...
  [
    ...
    Mongoid::Associations::Referenced::HasMany,
    Mongoid::Associations::Referenced::HasOne,
    ...
    context "when the association type is #{association_class}" do
      ...
      describe 'the :as option' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :as) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :as) do
      ...
      describe '#autobuilding?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :autobuild) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :autobuild) do
      ...
      describe '#autosave?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :autosave) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :autosave) do
      ...
      describe 'the :dependent option' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :dependent) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :dependent) do
      ...
      describe 'the :foreign_key option' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :foreign_key) do
          ...
          context 'when the association stores the foreign key', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :foreign_key) &&
                                                                     Mongoid::Associations::SpecHelpers.stores_foreign_key?(association_class) do
          ...
          context 'when the association does not store the foreign key', if: !Mongoid::Associations::SpecHelpers.stores_foreign_key?(association_class) &&
                                                                              Mongoid::Associations::SpecHelpers.stores_foreign_key?(association_class) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :foreign_key) do
      ...
      describe 'the :primary_key option' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :primary_key) do
          ...
          context 'when the option is not specified' do
            ...
            it 'returns the default primary key' do
              expect(association.primary_key).to eq(Mongoid::Associations::Relatable::PRIMARY_KEY_DEFAULT)
            end
          end
        end

        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :primary_key) do
      ...
      describe '#indexed?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :index) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :index) do
      ...
      describe '#polymorphic' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :polymorphic) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :polymorphic) do
      ...
      describe '#cascading_callbacks?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :cascade_callbacks) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :cascade_callbacks) do
      ...
      describe '#cyclic?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :cyclic) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :cyclic) do
      ...
      describe '#counter_cached?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :counter_cache) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :counter_cache) do
      ...
      describe '#validate?' do
        ...
        context 'when the option is supported by the association type', if: Mongoid::Associations::SpecHelpers.supports_option?(association_class, :validate) do
        ...
        context 'when the option is not supported by the association type', if: !Mongoid::Associations::SpecHelpers.supports_option?(association_class, :validate) do

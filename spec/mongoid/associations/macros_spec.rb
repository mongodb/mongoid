...
describe Mongoid::Associations::Macros do
  ...
  describe "#relations" do
    ...
    it "has keys that are the relation name" do
      expect(klass.allocate.relations['name']).to be_a(Mongoid::Associations::Embedded::EmbedsOne)
    end
    ...
    it "has values that are association" do
      ...
      ).to be_a_kind_of(Mongoid::Associations::Embedded::EmbedsOne)
    end
  end
  ...
  describe ".relations" do
    ...
    it "has values that are association" do
      ...
      ).to be_a(Mongoid::Associations::Embedded::EmbedsOne)
    end
  end

...
describe Mongoid::Associations::Embedded::EmbeddedIn do
  ...
  describe '#VALID_OPTIONS' do
    ...
    it 'returns the SHARED options with the ASSOCIATION_OPTIONS' do
      expect(association.class::VALID_OPTIONS).to match_array(Mongoid::Associations::Relatable::SHARED_OPTIONS +
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Embedded::EmbeddedIn::Builder' do
      expect(association.builder(double, double)).to be_a(Mongoid::Associations::Embedded::EmbeddedIn::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Embedded::EmbeddedIn::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Embedded::EmbeddedIn::Proxy)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an instance of Mongoid::Associations::Embedded::EmbeddedIn::Proxy' do
      expect(Mongoid::Associations::Embedded::EmbeddedIn::Proxy).to receive(:new).and_call_original

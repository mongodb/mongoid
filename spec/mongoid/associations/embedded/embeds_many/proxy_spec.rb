...
describe Mongoid::Associations::Embedded::EmbedsMany::Proxy do
  ...
  describe ".builder" do
    ...
    it "returns the many builder" do
      ...
      ).to be_a(Mongoid::Associations::Embedded::EmbedsMany::Builder)
    end
  end
  ...
  describe "#respond_to?" do
    ...
    Mongoid::Associations::Embedded::EmbedsMany::Proxy.public_instance_methods.each do |method|

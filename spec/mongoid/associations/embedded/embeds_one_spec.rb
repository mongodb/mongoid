...
describe Mongoid::Associations::Embedded::EmbedsOne do
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Embedded::EmbedsOne::Builder' do
      expect(association.builder(double, double)).to be_a(Mongoid::Associations::Embedded::EmbedsOne::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Embedded::EmbedsOne::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Embedded::EmbedsOne::Proxy)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an the target (EmbeddedObject)' do
      expect(Mongoid::Associations::Embedded::EmbedsOne::Proxy).to receive(:new).and_call_original

...
describe Mongoid::Associations::Embedded::EmbedsMany do
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Embedded::EmbedsMany::Builder' do
      expect(association.builder(double, double)).to be_a(Mongoid::Associations::Embedded::EmbedsMany::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Embedded::EmbedsMany::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Embedded::EmbedsMany::Proxy)
    end
  end

...
describe Mongoid::Associations::Touchable do
  ...
  describe "#touch" do
    ...
    context "when the document is embedded" do
      ...
      before do
        Label.send(:include, Mongoid::Associations::Touchable::InstanceMethods)
      end
    ...
    context "when no relations have touch options" do
      ...
      before do
        Person.send(:include, Mongoid::Associations::Touchable::InstanceMethods)
        Agent.send(:include, Mongoid::Associations::Touchable::InstanceMethods)
      end
    ...
    context "when relations have touch options" do
      ...
      context "when the relation is a parent of an embedded doc" do
        ...
        before do
          Page.send(:include, Mongoid::Associations::Touchable::InstanceMethods)
          Edit.send(:include, Mongoid::Associations::Touchable::InstanceMethods)
        end
      ...
      context "when the parent of embedded doc has cascade callbacks" do
        ...
        before do
          Band.send(:include, Mongoid::Associations::Touchable::InstanceMethods)
        end

...
describe Mongoid::Associations::Referenced::HasMany do
  ...
  describe '#setup_instance_methods!' do
    ...
    it 'sets up a ids getter for the relation' do
      expect(Mongoid::Associations::Accessors).to receive(:define_ids_getter!).with(association)
      association.setup_instance_methods!
    end
    ...
    it 'sets up a ids setter for the relation' do
      expect(Mongoid::Associations::Accessors).to receive(:define_ids_setter!).with(association)
      association.setup_instance_methods!
    end
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Referenced::HasMany::Builder' do
      expect(association.builder(double, double)).to be_a(Mongoid::Associations::Referenced::HasMany::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Referenced::HasMany::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Referenced::HasMany::Proxy)
    end
  end
  ...
  describe '#nested_builder' do
    ...
    it 'returns an instance of Associations::Nested::Many' do
      expect(association.nested_builder({}, {})).to be_a(Mongoid::Associations::Nested::Many)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an the target (EmbeddedObject)' do
      expect(Mongoid::Associations::Referenced::HasMany::Proxy).to receive(:new).and_call_original

...
describe Mongoid::Associations::Referenced::HasOne do
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Referenced::HasOne::Builder' do
      expect(association.builder(double, double)).to be_a(Mongoid::Associations::Referenced::HasOne::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Referenced::HasOne::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Referenced::HasOne::Proxy)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an the target (EmbeddedObject)' do
      expect(Mongoid::Associations::Referenced::HasOne::Proxy).to receive(:new).and_call_original

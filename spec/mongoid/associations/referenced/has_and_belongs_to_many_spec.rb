...
describe Mongoid::Associations::Referenced::HasAndBelongsToMany do
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Referenced::HasAndBelongsToMany::Builder' do
      expect(association.builder(double, double)).to be_a(
        Mongoid::Associations::Referenced::HasAndBelongsToMany::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Referenced::HasAndBelongsToMany::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Referenced::HasAndBelongsToMany::Proxy)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an the target' do
      expect(Mongoid::Associations::Referenced::HasAndBelongsToMany::Proxy).to receive(:new).and_call_original

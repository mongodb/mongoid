...
describe Mongoid::Associations::Referenced::HasAndBelongsToMany::Proxy do
  ...
  describe "#respond_to?" do
    ...
    Mongoid::Associations::Referenced::HasAndBelongsToMany::Proxy.public_instance_methods.each do |method|

...
describe Mongoid::Associations::Referenced::HasMany::Proxy do
  ...
  describe ".builder" do
    ...
    let(:builder_klass) do
      Mongoid::Associations::Referenced::HasMany::Builder
    end
  ...
  describe "#respond_to?" do
    ...
    Mongoid::Associations::Referenced::HasMany::Proxy.public_instance_methods.each do |method|

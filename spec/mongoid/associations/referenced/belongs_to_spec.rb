...
describe Mongoid::Associations::Referenced::BelongsTo do
  ...
  describe '#setup_instance_methods!' do
    ...
    it 'sets up a getter for the relation' do
      expect(Mongoid::Associations::Accessors).to receive(:define_getter!).with(association)
      association.setup_instance_methods!
    end

    it 'sets up a setter for the relation' do
      expect(Mongoid::Associations::Accessors).to receive(:define_setter!).with(association)
      association.setup_instance_methods!
    end

    it 'sets up an existence check for the relation' do
      expect(Mongoid::Associations::Accessors).to receive(:define_existence_check!).with(association)
      association.setup_instance_methods!
    end

    it 'sets up the builder for the relation' do
      expect(Mongoid::Associations::Builders).to receive(:define_builder!).with(association)
      association.setup_instance_methods!
    end

    it 'sets up the creator for the relation' do
      expect(Mongoid::Associations::Builders).to receive(:define_creator!).with(association)
      association.setup_instance_methods!
    end
    ...
    context 'autosave' do
      ...
      context 'when the :autosave option is true' do
        ...
        it 'sets up autosave' do
          expect(Mongoid::Associations::Referenced::AutoSave).to receive(:define_autosave!).with(association)
          association.setup_instance_methods!
        end
      end
      ...
      context 'when the :autosave option is false' do
        ...
        it 'does not set up autosave' do
          expect(Mongoid::Associations::Referenced::AutoSave).not_to receive(:define_autosave!)
          association.setup_instance_methods!
        end
      end
    ...
    context 'counter cache callbacks' do
      ...
      context 'when the :counter_cache option is true' do
        ...
        it 'sets up counter cache callbacks' do
          expect(Mongoid::Associations::Referenced::CounterCache).to receive(:define_callbacks!).with(association)
          association.setup_instance_methods!
        end
      end
      ...
      context 'when the :counter_cache option is false' do
        ...
        it 'does not set up counter cache callbacks' do
          expect(Mongoid::Associations::Referenced::CounterCache).not_to receive(:define_callbacks!)
          association.setup_instance_methods!
        end
      end
    ...
    context 'dependent' do
      ...
      context 'when the dependent option is provided' do
        ...
        context 'when the dependent option is :delete_all' do
          ...
          it 'sets up the dependency' do
            expect(Mongoid::Associations::Depending).to receive(:define_dependency!)
            association.setup_instance_methods!
          end
        end
      ...
      context 'when the dependent option is not provided' do
        ...
        it 'does not set up the dependency' do
          expect(Mongoid::Associations::Depending).not_to receive(:define_dependency!)
          association.setup_instance_methods!
        end
      end
    end
    ...
    context 'touchable' do
      ...
      context 'when the :touch option is true' do
        ...
        it 'sets up touch' do
          expect(Mongoid:: Associations::Touchable).to receive(:define_touchable!).with(association)
          association.setup_instance_methods!
        end
      end
      ...
      context 'when the :touch option is false' do
        ...
        it 'does not set up touch' do
          expect(Mongoid:: Associations::Touchable).not_to receive(:define_touchable!).with(association)
          association.setup_instance_methods!
        end
      end
  ...
  describe '#builder' do
    ...
    it 'returns an instance of Mongoid::Associations::Referenced::BelongsTo::Builder' do
      expect(association.builder(double, double)).to be_a(Mongoid::Associations::Referenced::BelongsTo::Builder)
    end
  end

  describe '#relation' do

    it 'returns Mongoid::Associations::Referenced::BelongsTo::Proxy' do
      expect(association.relation).to be(Mongoid::Associations::Referenced::BelongsTo::Proxy)
    end
  end
  ...
  describe '#nested_builder' do
    ...
    it 'returns an instance of Associations::Nested::One' do
      expect(association.nested_builder({}, {})).to be_a(Mongoid::Associations::Nested::One)
    end
  end
  ...
  describe '#create_relation' do
    ...
    it 'returns an instance of Mongoid::Associations::Referenced::BelongsTo::Proxy' do
      expect(Mongoid::Associations::Referenced::BelongsTo::Proxy).to receive(:new).and_call_original

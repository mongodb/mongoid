...
describe Mongoid::Cacheable do
  ...
  describe ".included" do
    ...
    it 'does not allow an attribute with the name :cache_timestamp_format' do
      expect {
        Class.new do
          include Mongoid::Document

          field :cache_timestamp_format, type: String
        end
  ...
  describe "#cache_key" do
    ...
    context "when the model doesn't have Timestamps" do

...
describe Mongoid::Relations::Embedded::Many do
  ...
  describe "#exists?" do
    ...
    context "when documents exist in the database" do
      ...
      it "returns true" do
        expect(person.addresses.exists?).to be_truthy
      end
    end
    ...
    context "when no documents exist in the database" do
      ...
      it "returns false" do
        expect(person.addresses.exists?).to be_falsey
      end
    end
  end
  ...
  describe "#respond_to?" do
    ...
    Array.public_instance_methods.each do |method|
      ...
      context "when checking #{method}" do
        ...
        it "returns true" do
          expect(addresses.respond_to?(method)).to be_truthy
        end
      end
    end
  ...
  describe "#update_all" do
    ...
    context "when there are no documents present" do
      ...
      it "updates nothing" do
        expect(person.addresses.update_all(street: "test")).to be_falsey
      end
    end
  ...
  context "when pushing with a before_add callback" do
    ...
    context "when no errors are raised" do
      ...
      it "executes the callback" do
        expect(artist.before_add_called).to be_truthy
      end

      it "executes the callback as proc" do
        expect(song.before_add_called).to be_truthy
      end
  ...
  context "when pushing with an after_add callback" do
    ...
    it "executes the callback" do
      artist.labels << label
      expect(artist.after_add_called).to be_truthy
    end
  ...
  context "#delete or #clear with before_remove callback" do
    ...
    context "when no errors are raised" do
      ...
      describe "#delete" do
        ...
        it "executes the callback" do
          expect(artist.before_remove_embedded_called).to be_truthy
        end
  ...
  context "#delete or #clear with after_remove callback" do
    ...
    context "when no errors are raised" do
      ...
      describe "#delete" do
        ...
        it "executes the callback" do
          expect(artist.after_remove_embedded_called).to be_truthy
        end
      end

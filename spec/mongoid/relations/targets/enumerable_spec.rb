...
describe Mongoid::Relations::Targets::Enumerable do
  ...
  describe "#===" do
    ...
    context "when compared to an array class" do
      ...
      it "returns true" do
        expect(enumerable === Array).to be_truthy
      end
    end
    ...
    context "when compared to a different class" do
      ...
      it "returns false" do
        expect(enumerable === Mongoid::Document).to be_falsey
      end
    end
    ...
    context "when compared to an array instance" do
      ...
      context "when the entries are equal" do
        ...
        it "returns true" do
          expect(enumerable === other).to be_truthy
        end
      end
      ...
      context "when the entries are not equal" do
        ...
        it "returns false" do
          expect(enumerable === other).to be_falsey
        end
      end
    end
  end
  ...
  describe "#each" do
    ...
    context "when no block is passed" do
      ...
      it "returns an enumerator" do
        expect(enumerable.each.class.include?(Enumerable)).to be_truthy
      end
  ...
  describe "#is_a?" do
    ...
    context "when checking against enumerable" do
      ...
      it "returns true" do
        expect(enumerable.is_a?(::Enumerable)).to be_truthy
      end
    end
    ...
    context "when checking against array" do
      ...
      it "returns true" do
        expect(enumerable.is_a?(Array)).to be_truthy
      end
    end
  end
  ...
  describe "#kind_of?" do
    ...
    context "when checking against enumerable" do
      ...
      it "returns true" do
        expect(enumerable.kind_of?(::Enumerable)).to be_truthy
      end
    end
    ...
    context "when checking against array" do
      ...
      it "returns true" do
        expect(enumerable.kind_of?(Array)).to be_truthy
      end
    end
  end

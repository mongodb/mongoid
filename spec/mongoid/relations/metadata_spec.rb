...
describe Mongoid::Relations::Metadata do
  ...
  describe "#extension?" do
    ...
    context "when an extends property exists" do
      ...
      it "returns true" do
        expect(metadata.extension?).to be_truthy
      end
    end
    ...
    context "when the extend option is nil" do
      ...
      it "returns false" do
        expect(metadata.extension?).to be_falsey
      end
    end
  end
  ...
  describe "#indexed?" do
    ...
    context "when an index property exists" do
      ...
      it "returns true" do
        expect(metadata.indexed?).to be_truthy
      end
    end
    ...
    context "when the index option is nil" do
      ...
      it "returns false" do
        expect(metadata.indexed?).to be_falsey
      end
    end
  ...
  describe "#validate?" do
    ...
    context "when validate is provided" do
      ...
      context "when validate is true" do
        ...
        it "returns true" do
          expect(metadata.validate?).to be_truthy
        end
      end
      ...
      context "when validate is false" do
        ...
        it "returns false" do
          expect(metadata.validate?).to be_falsey
        end
      end
    end
    ...
    PROPERTIES.each do |property|
      ...
      describe "##{property}?" do
        ...
        context "when a #{property} property exists" do
          ...
          it "returns true" do
            expect(metadata.send("#{property}?")).to be_truthy
          end
        end
        ...
        context "when the #{property} property is nil" do
          ...
          it "returns false" do
            expect(metadata.send("#{property}?")).to be_falsey
          end
        end
      end
    end

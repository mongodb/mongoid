...
describe Mongoid::Relations::Builders::NestedAttributes::One do
  ...
  describe "#allow_destroy?" do
    ...
    context "when the option is provided" do
      ...
      it "returns the option" do
        expect(builder.allow_destroy?).to be_truthy
      end
    end
    ...
    context "when the option is not provided" do
      ...
      it "returns false" do
        expect(builder.allow_destroy?).to be_falsey
      end
    end
  end
  ...
  describe "#destroy" do
    ...
    context "when the attribute exists" do
      ...
      it "returns the value" do
        expect(builder.destroy).to be_truthy
      end
    end
  ...
  describe "#reject?" do
    ...
    context "when the proc is provided" do
      ...
      context "when the proc matches" do
        ...
        it "returns true" do
          expect(builder.reject?(builder, { last_name: "Lang" })).to be_truthy
        end
      end
      ...
      context "when the proc does not match" do
        ...
        it "returns false" do
          expect(builder.reject?(builder, { first_name: "Lang" })).to be_falsey
        end
      end
    end
  ...
  describe "#update_only?" do
    ...
    context "when the option is provided" do
      ...
      it "returns the option" do
        expect(builder.update_only?).to be_truthy
      end
    end
    ...
    context "when the option is not provided" do
      ...
      it "returns false" do
        expect(builder.update_only?).to be_falsey
      end
    end
  end
end

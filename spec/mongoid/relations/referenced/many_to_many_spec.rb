...
describe Mongoid::Relations::Referenced::ManyToMany do
      ...
      context "when association has callbacks" do
        ...
        context "when the callback is a before_add" do
          ...
          it "executes the callback" do
            ...
            expect(post.before_add_called).to be_truthy
          end
        ...
        context "when the callback is an after_add" do
          ...
          it "executes the callback" do
            post.tags.send(method, tag)
            expect(post.after_add_called).to be_truthy
          end
    ...
    context "when :dependent => :nullify is set" do
      ...
      context "when :inverse_of is set" do
        ...
        it "deletes the document" do
          expect(event.delete).to be_truthy
        end
      end
    end
  ...
  describe "#exists?" do
    ...
    context "when documents exist in the database" do
      ...
      it "returns true" do
        expect(person.preferences.exists?).to be_truthy
      end
    end
    ...
    context "when no documents exist in the database" do
      ...
      it "returns false" do
        expect(person.preferences.exists?).to be_falsey
      end
    end
  end
  ...
  describe "#respond_to?" do
    ...
    Array.public_instance_methods.each do |method|
      ...
      context "when checking #{method}" do
        ...
        it "returns true" do
          expect(preferences.respond_to?(method)).to be_truthy
        end
      end
    end
  ...
  describe ".stores_foreign_key?" do
    ...
    it "returns true" do
      expect(described_class.stores_foreign_key?).to be_truthy
    end
  end

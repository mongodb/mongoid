...
describe Mongoid::Relations::Referenced::Many do
  ...
  describe "#exists?" do
    ...
    context "when documents exist in the database" do
      ...
      it "returns true" do
        expect(person.posts.exists?).to be_truthy
      end
    end
    ...
    context "when no documents exist in the database" do
      ...
      it "returns false" do
        expect(person.posts.exists?).to be_falsey
      end
    end
  end
  ...
  describe "#respond_to?" do
    ...
    Array.public_instance_methods.each do |method|
      ...
      context "when checking #{method}" do
        ...
        it "returns true" do
          expect(posts.respond_to?(method)).to be_truthy
        end
      end
    end
  ...
  describe ".stores_foreign_key?" do
    ...
    it "returns false" do
      expect(described_class.stores_foreign_key?).to be_falsey
    end
  end
  ...
  describe ".validation_default" do
    ...
    it "returns true" do
      expect(described_class.validation_default).to be_truthy
    end
  end
  ...
  context "when pushing with a before_add callback" do
    ...
    context "when execution raises no errors" do
      ...
      it "it executes method callbacks" do
        expect(artist.before_add_referenced_called).to be_truthy
      end

      it "it executes proc callbacks" do
        expect(album.before_add_called).to be_truthy
      end
  ...
  context "when pushing with an after_add callback" do
    ...
    it "executes the callback" do
      artist.albums << album
      expect(artist.after_add_referenced_called).to be_truthy
    end
  ...
  context "when #delete or #clear with before_remove callback" do
    ...
    context "when executing raises no errors" do
      ...
      describe "#delete" do
        ...
        it "executes the callback" do
          expect(artist.before_remove_referenced_called).to be_truthy
        end
  ...
  context "when #delete or #clear with after_remove callback" do
    ...
    context "without errors" do
      ...
      describe "#delete" do
        ...
        it "executes the callback" do
          expect(artist.after_remove_referenced_called).to be_truthy
        end
      end

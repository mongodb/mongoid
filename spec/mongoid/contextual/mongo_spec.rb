...
describe Mongoid::Contextual::Mongo do
  ...
  [ :blank?, :empty? ].each do |method|
    ...
    describe "##{method}" do
      ...
      context "when the count is zero" do
        ...
        it "returns true" do
          expect(context.send(method)).to be_truthy
        end
      end
      ...
      context "when the count is greater than zero" do
        ...
        it "returns false" do
          expect(context.send(method)).to be_falsey
        end
      end
    end
  end
  ...
  describe "#update" do
    ...
    context "when providing no attributes" do
      ...
      it "returns false" do
        expect(context.update).to be_falsey
      end
    end
  end
  ...
  describe "#update_all" do
    ...
    context "when providing no attributes" do
      ...
      it "returns false" do
        expect(context.update_all).to be_falsey
      end
    end
  end
end

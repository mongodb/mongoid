  ...
  describe "#load!" do
    ...
    context "when provided an environment" do
      ...
      it "sets the include root in json option" do
        expect(described_class.include_root_in_json).to be_falsey
      end

      it "sets the include type with serialization option" do
        expect(described_class.include_type_for_serialization).to be_falsey
      end

      it "sets the scope overwrite option" do
        expect(described_class.scope_overwrite_exception).to be_falsey
      end

      it "sets the preload models option" do
        expect(described_class.preload_models).to be_falsey
      end

      it "sets the raise not found error option" do
        expect(described_class.raise_not_found_error).to be_truthy
      end

      it "sets the use activesupport time zone option" do
        expect(described_class.use_activesupport_time_zone).to be_truthy
      end

      it "sets the use utc option" do
        expect(described_class.use_utc).to be_falsey
      end
    end

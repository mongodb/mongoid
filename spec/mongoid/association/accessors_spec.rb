  ...
  describe "\#{getter}?" do
    ...
    context 'when the association is a has one' do
      ...
      context 'when the association does not exist' do
        context 'when not autobuilding' do
          it 'returns false' do
            expect(person).not_to have_game
          end
        end

        context 'when autobuilding' do
          it 'returns false' do
            expect(person).not_to have_book
          end
        end
      end
    end
    ...
    context 'when the association is a has many' do
      ...
      context 'when the association does not have documents' do
        it 'returns false' do
          expect(person).not_to have_posts
        end
      end
    end
    ...
    context 'when the association is a has and belongs to many' do
      ...
      context 'when the association does not have documents' do
        it 'returns false' do
          expect(person).not_to have_preferences
        end
      end
    end
    ...
    context 'when the association is a belongs to' do
      ...
      context 'when the association does not exist' do
        context 'when the association does not autobuild' do
          ...
          it 'returns false' do
            expect(game).not_to have_person
          end
        end
        ...
        context 'when the association autobuilds' do
          ...
          it 'returns false' do
            expect(book).not_to have_person
          end
        end
      end
    end
    ...
    context 'when the association is an embeds one' do
      ...
      context 'when the association does not exist' do
        context 'when the association does not autobuild' do
          it 'returns false' do
            expect(person).not_to have_name
          end
        end
        ...
        context 'when the association autobuilds' do
          ...
          it 'returns false' do
            expect(person).not_to have_passport
          end
        end
      end
    ...
    context 'when the association is an embeds many' do
      ...
      context 'when the association does not have documents' do
        it 'returns false' do
          expect(person).not_to have_addresses
        end
      end
    end
    ...
    context 'when the association is an embedded in' do
      ...
      context 'when the association does not exist' do
        context 'when the association does not autobuild' do
          ...
          it 'returns false' do
            expect(name).not_to have_namable
          end
        end
        ...
        context 'when the association autobuilds' do
          ...
          it 'returns false' do
            expect(passport).not_to have_person
          end
        end
      end
    end
    ...
    context 'when the association is not polymorphic' do
      ...
      context 'when the association is a many to many' do
        ...
        context 'when reloading the association directly' do
          ...
          it 'reloads a new instance' do
            expect(preferences.first).not_to equal(preference)
          end
        end
      ...
      context 'when the association is a many to one' do
        ...
        context 'when reloading the association directly' do
          ...
          it 'reloads a new instance' do
            expect(posts.first).not_to equal(post)
          end
        end
      ...
      context 'when the association is a references one' do
        ...
        context 'when reloading the association directly' do
          ...
          it 'reloads a new instance' do
            expect(reloaded_game).not_to equal(game)
          end
        end
          ...
          it 'does not create an accessor for another field on the embedded document' do
            expect do
              persisted_person.passport.country
                               ...
                               /Attempted to access attribute 'country' on Passport which was not loaded/)
          end
        end
          ...
          it 'does not create an accessor for another field on the embedded document' do
            expect do
              persisted_person.phone_numbers.first.landline
                               ...
                               /Attempted to access attribute 'landline' on Phone which was not loaded/)
          end
        end

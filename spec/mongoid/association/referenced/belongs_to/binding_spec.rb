  ...
  describe '#bind_one' do
    context 'when the child of an references one' do
      ...
      context 'when the document is not bindable' do
        ...
        it 'does nothing' do
          expect(game).not_to receive(:person=).with(person)
    ...
    context 'when the child of an references many' do
      ...
      context 'when the document is not bindable' do
        ...
        it 'does nothing' do
          expect(post).not_to receive(:person=)
          binding.bind_one
        end
      end
    end
  ...
  describe '#unbind_one' do
    context 'when the child of an references one' do
      ...
      context 'when the document is unbindable' do
        before do
          binding.bind_one
          expect(person).not_to receive(:delete)
          expect(game).not_to receive(:delete)
          binding.unbind_one
        end
      ...
      context 'when the document is not unbindable' do
        it 'does nothing' do
          expect(game).not_to receive(:person=)
          binding.unbind_one
        end
      end
    end

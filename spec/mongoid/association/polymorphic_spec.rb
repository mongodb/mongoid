...
describe 'Polymorphic Associations' do
  describe '#polymorph' do
    ...
    context 'when the relation is polymorphic' do
      context 'when the relation stores a foreign key' do
        ...
        it 'adds the foreign key type field' do
          expect(klass.fields['ratable_type']).not_to be_nil
        end
      end
    ...
    context 'when the relation is not polymorphic' do
      ...
      it 'sets polymorphic to false' do
        expect(klass).not_to be_polymorphic
      end
  ...
  describe '.polymorphic?' do
    ...
    context 'when the document is not in a polymorphic relation' do
      it 'returns false' do
        expect(Survey).not_to be_polymorphic
      end
    end
  end
  ...
  describe '#polymorphic?' do
    ...
    context 'when the document is not in a polymorphic relation' do
      it 'returns false' do
        expect(Survey.new).not_to be_polymorphic
      end
    end
  end

...
describe Mongoid::Refinements::Extension do
  ...
  describe "#evolve_object_id" do
    ...
    it "returns self" do
      expect(object_id.evolve_object_id).to eq(object_id)
    end

    it "returns the same instance" do
      expect(object_id.evolve_object_id).to equal(object_id)
    end
  end
  ...
  describe "#mongoize_object_id" do
    ...
    it "returns self" do
      expect(object_id.mongoize_object_id).to eq(object_id)
    end

    it "returns the same instance" do
      expect(object_id.mongoize_object_id).to equal(object_id)
    end
  end
end

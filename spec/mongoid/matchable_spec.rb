  ...
  describe "#matches?" do
    ...
    context "when document is embeded" do
      ...
      context "when the attributes do not match" do
        ...
        it "returns false" do
          expect(document.locations.first.matches?(selector)).to be_falsey
        end
      ...
      context "when matching embedded hash values" do
        ...
        context "when the contents match" do
          ...
          it "returns true" do
            expect(document.locations.first.matches?(selector)).to be_truthy
          end
        end
    ...
    context "when performing simple matching" do
      ...
      context "when the attributes match" do
        ...
        it "returns true" do
          expect(document.matches?(selector)).to be_truthy
        end
      end
      ...
      context "when the attributes dont match" do
        ...
        it "returns false" do
          expect(document.matches?(selector)).to be_falsey
        end
      end
    end

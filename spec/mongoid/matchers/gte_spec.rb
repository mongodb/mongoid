...
describe Mongoid::Matchers::Gte do
  ...
  describe "#matches?" do
    ...
    context "when the value is larger" do
      ...
      it "returns true" do
        expect(matcher.matches?("$gte" => 3)).to be_true
      end
    end
    ...
    context "when the value is smaller" do
      ...
      it "returns false" do
        expect(matcher.matches?("$gte" => 10)).to be_false
      end
    end
    ...
    context "when the value is equal" do
      ...
      it "returns true" do
        expect(matcher.matches?("$gte" => 5)).to be_true
      end
    end
    ...
    context "when the value is nil" do
      ...
      it "returns false" do
        expect(matcher.matches?("$gte" => 5)).to be_false
      end
    end

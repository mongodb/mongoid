...
describe Mongoid::Criteria do
  ...
  describe "#===" do
    ...
    context "when the other is a criteria" do
      ...
      it "returns true" do
        expect(described_class === other).to be_truthy
      end
    end
    ...
    context "when the other is not a criteria" do
      ...
      it "returns false" do
        expect(described_class === []).to be_falsey
      end
    end
  end
  ...
  describe "#exists?" do
    ...
    context "when matching documents exist" do
      ...
      it "returns true" do
        expect(criteria.exists?).to be_truthy
      end
    end
    ...
    context "when no matching documents exist" do
      ...
      it "returns false" do
        expect(criteria.exists?).to be_falsey
      end
    end
  end
    ...
    context "when not using inheritance" do
      ...
      context "when instantiating a document not in the result set" do
        ...
        it "only limits the fields on the correct criteria" do
          criteria.each do |band|
            expect(Band.new.active).to be_truthy
          end
        end
      end
  ...
  describe "#respond_to?" do
    ...
    context "when asking about a model private class method" do
      ...
      context "when including private methods" do
        ...
        it "returns true" do
          expect(criteria.respond_to?(:for_ids, true)).to be_truthy
        end
      end
    end
    ...
    context "when asking about a model class public instance method" do
      ...
      it "returns true" do
        expect(criteria.respond_to?(:join)).to be_truthy
      end
    end
    ...
    context "when asking about a model private instance method" do
      ...
      context "when including private methods" do
        ...
        it "returns true" do
          expect(criteria.respond_to?(:fork, true)).to be_truthy
        end
      end
    end
    ...
    context "when asking about a private criteria instance method" do
      ...
      context "when including private methods" do
        ...
        it "returns true" do
          expect(criteria.respond_to?(:puts, true)).to be_truthy
        end
      end
    end
  end

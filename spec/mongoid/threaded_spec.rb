...
describe Mongoid::Threaded do
  ...
  describe "#validated?" do
    ...
    context "when the document is validated" do
      ...
      it "returns true" do
        expect(described_class.validated?(person)).to be_truthy
      end
    end
    ...
    context "when the document is not validated" do
      ...
      it "returns false" do
        expect(described_class.validated?(person)).to be_falsey
      end
    end
  end
  ...
  describe "#autosaved?" do
    ...
    context "when the document is autosaved" do
      ...
      it "returns true" do
        expect(described_class.autosaved?(person)).to be_truthy
      end
    end
    ...
    context "when the document is not autosaved" do
      ...
      it "returns false" do
        expect(described_class.autosaved?(person)).to be_falsey
      end
    end
  end
end

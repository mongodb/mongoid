...
describe Mongoid::Matchers::Gte do
  ...
  describe "#matches?" do
    ...
    context "when the value is larger" do
      ...
      it "returns true" do
        matcher.matches?("$gte" => 3).should be_truthy
      end
    ...
    context "when the value is smaller" do
      ...
      it "returns false" do
        matcher.matches?("$gte" => 10).should be false
      end
    ...
    context "when the value is equal" do
      ...
      it "returns true" do
        matcher.matches?("$gte" => 5).should be_truthy
      end
    ...
    context "when the value is nil" do
      ...
      it "returns false" do
        matcher.matches?("$gte" => 5).should be false
      end

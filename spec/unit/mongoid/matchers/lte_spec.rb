...
describe Mongoid::Matchers::Lte do
  ...
  describe "#matches?" do
    ...
    context "when the value is larger" do
      ...
      it "returns false" do
        matcher.matches?("$lte" => 3).should be false
      end
    ...
    context "when the value is smaller" do
      ...
      it "returns true" do
        matcher.matches?("$lte" => 10).should be_truthy
      end
    ...
    context "when the value is equal" do
      ...
      it "returns true" do
        matcher.matches?("$lte" => 5).should be_truthy
      end
    ...
    context "when the value is nil" do
      ...
      it "returns false" do
        matcher.matches?("$lte" => 5).should be false
      end
